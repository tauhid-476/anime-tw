...
export async function POST(req: NextRequest) {
  ...
  try {
   ...
   - *tweets per day:* ${userData.tweets_per_day}
    ...
    ROAST HIM A ALL WHILE HIGHLITING YOUR COOLNESS , PERSONALITY , SHOW HIM HOW CAN HE BE LIKE YOU , USE YOUR SIGNATURE STYLE  , USE EMOJI WHICH MATCHES YOUR CHARACTER , PLEASE DONT USE THE PROVIDED INFORMATION DIRECTLY , USE THEM INDIRECTLY AND ROAST HIM. COMPOSE THIS MESSAGE OF LIKE 10-12 LINES
   `;
